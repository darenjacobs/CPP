...
int main()
{
	...
	while (tryAgain == 1)
	{
 			double loanAmount = 200000; // initialize the loan amount to 0.
			...
			cout << "3: " << term[1] << " year term at " << interestRate[2] << "% interest rate" << endl;
			...
			switch (termRate)
			{
				...
				case 0: cout << "Have a nice day!" << endl; exit(0); break;
				default: cout << "You have made an invalid selection." << endl;
			}
			cout <<"Try again?  Enter 1 for yes" << endl;
			cin >> tryAgain;
	}
