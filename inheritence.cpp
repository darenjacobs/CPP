...
public:
        ...
        void breath() {
                cout << "nspiration occurs when the diaphram and the external intercostal muscles contract.  Expiration occurs when the diaphram and the intercostal muscles relax.\n" << endl;
        }
};

class Dog:public HomePet {
private:
        string earsSize; // small, mediumm, large
public:
