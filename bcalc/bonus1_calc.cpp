...
// This program calculates the employee bonus based on two items, performance factor and number of years working for the company.
// If the performance factor is below 5 the employee receives no bonus.
// If the performance factor is 5 or above and the employee has been working for the company for less than 5 years then the bonus is 1%.
// If the performance factor is 5 or above and the employee has been working for the company for 5 or more years then the bonus is 2%.
